class ProjectKeysController < ApplicationController
  ...
  def create
    ...
    _record, raw_key = ProjectKey.generate_for(@project, name: key_params[:name])
    redirect_to @project, flash: { project_key: raw_key }, notice: t(".created")
  end
  ...
  def regenerate
    ...
    _new_key, raw_key = ProjectKey.generate_for(@project, name: "#{@project_key.name} (regenerated)")
    redirect_to @project, flash: { project_key: raw_key }, notice: t(".regenerated")
  end
